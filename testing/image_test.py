...
print("For the explicit image", classifier.classify_video('EXPLICIT/explicit_test_video.mp4')) # Returns {"metadata": {"fps": FPS, "video_length": TOTAL_N_FRAMES, "video_path": 'path_to_video'},"preds": {frame_i: {'safe': PROBABILITY, 'unsafe': PROBABILITY}, ....}}
